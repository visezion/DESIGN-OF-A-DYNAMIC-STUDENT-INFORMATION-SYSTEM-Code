...
$sql="INSERT INTO  tblsubjects(SubjectName,SubjectCode,SubjectUnit) VALUES(:subjectname,:subjectcode,:subjectunit)";
...
<div class="alert alert-success left-icon-alert" role="alert">
 ...
 <input type="text" name="subjectname" class="form-control" id="default" placeholder="Subject Name" required="required">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="number" name="subjectunit" class="form-control" id="default" placeholder="Subject Unit" required="required">
                                                        </div>
                                                    </div>
<div class="form-group">
