...
$sql="update  tblsubjects set SubjectName=:subjectname,SubjectUnit=:subjectunit,SubjectCode=:subjectcode where id=:sid";
$query = $dbh->prepare($sql);
$query->bindParam(':subjectname',$subjectname,PDO::PARAM_STR);
$query->bindParam(':subjectcode',$subjectcode,PDO::PARAM_STR);
$query->bindParam(':subjectunit',$subjectunit,PDO::PARAM_STR);
...
{   ?>                                               
 ...
 <input type="text" name="subjectname" value="<?php echo htmlentities($result->SubjectName);?>" class="form-control" id="default" placeholder="Subject Name" required="required">
                                                     ...
                                                     <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Subject Unit</label>
                                                        <div class="col-sm-10">
 <input type="text" name="subjectunit" value="<?php echo htmlentities($result->SubjectUnit);?>" class="form-control" id="default" placeholder="Subject Unit" required="required">
                                                        </div>
                                                    </div>
<div class="form-group">
