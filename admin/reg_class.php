...
$class=$_POST['class']; 
$status=1;
$sql="INSERT INTO  tblclassreg(StudentId,ClassId,status) VALUES(:student,:class,:status)";
...
{   ?>
<option value="<?php echo htmlentities($result->StudentId); ?>"><?php echo htmlentities($result->StudentId); ?> :: <?php echo htmlentities($result->StudentName); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
...
foreach($results as $result)
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->id); ?> :: <?php echo htmlentities($result->ClassName); ?>&nbsp; Section-<?php echo htmlentities($result->Section); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
