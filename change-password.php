...
<?php include('includes/leftbar.php');?>                   
 <!-- /.left-sidebar -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Stdent change password</li>
            						</ul>
                                </div>
   ...
   <div class="panel-body">
                                                ...
                                                <form  name="chngpwd" method="post" action='change-passwordck.php' onSubmit="return valid();">
                                                    <input type=hidden name=todo value=change-password>
													<div class="form-group has-success">
                                                        <label for="success" class="control-label">Current Password</label>
                                                		<div class="">
                                    <input type="password" name="old_password" class="form-control" required="required" id="success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="password" name="password2" class="form-control" required="required" id="success">
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
