...
Visit http://www.plus2net.com/php_tutorial/php-membership.php  for script updates and more details. 
***********
...
Open forgot-passwordck.php file and set the value for varaible $site_url as per your site name and path
$site_url="http://www.plus2net.com/script-demo/signup/";
